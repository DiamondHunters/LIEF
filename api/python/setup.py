            ...
            if "cross-compilation" in cmake_conf._config["lief"]:
                ...
                if "platform" in cross_conf:
                    ...
                    if os.name == "nt" and platform == "win32":
                        ...
                        sys.platform = "win32"
        if not platform.mechine() in sysconfig.get_platform(): # cross-compilation
            ...
            if len(cross_platform) != 2 or not "linux " in cross_platform[0]: # focus on Linux
                ...
                os.environ["SETUPTOOLS_EXT_SUFFIX"] = sysconfig.get_config_var('EXT_SUFFIX').replace(platform.mechine(),cross_platform[1])
